...
const faqs = [
  ...
  {
    question: "How does the platform integrate with our existing marketing tools?",
    answer:
  ...
  {
    question: "Can we embed agents directly into our website or internal tools?",
    answer:
  ...
  },
  {
    ...
    answer:
      "Yes, the platform supports multiple users.",
  },
  {
  ...
  {
    question: "What if we need help with strategy beyond what the agents provide?",
    answer:
        ...
        <div className="max-w-4xl mx-auto">
          <div className="mb-8">
            <Button
              onClick={() => navigate(-1)}
              variant="ghost"
              className="text-gray-400 hover:text-white hover:bg-gray-800/50 mb-6"
            >
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-400 max-w-2xl mx-auto">
              Find answers to all your questions about MARQAIT B2B platform, agents, pricing, and more.
            </p>
          </div>

          <div className="space-y-6">
            <h2 className="text-2xl font-bold text-white mb-4">General Platform Questions</h2>
          ...
          <div className="space-y-6 mt-12">
            <h2 className="text-2xl font-bold text-white mb-4">Agent-Related Questions</h2>
            <Accordion type="single" collapsible className="space-y-4">
          ...
          <div className="space-y-6 mt-12">
            <h2 className="text-2xl font-bold text-white mb-4">Technical & Integration Questions</h2>
            <Accordion type="single" collapsible className="space-y-4">
          ...
          <div className="space-y-6 mt-12">
            <h2 className="text-2xl font-bold text-white mb-4">Usage & Performance Questions</h2>
            <Accordion type="single" collapsible className="space-y-4">
              {faqs.slice(10, 14).map((faq, index) => (
                <AccordionItem
                  key={index}
                  value={`usage-${index}`}
                  className="bg-gray-900/30 border border-gray-800 rounded-lg px-6 hover:border-violet-500/50 transition-colors !border-b-gray-800"
          ...
          <div className="space-y-6 mt-12">
            <h2 className="text-2xl font-bold text-white mb-4">Pricing & Business Questions</h2>
            <Accordion type="single" collapsible className="space-y-4">
              {faqs.slice(14, 18).map((faq, index) => (
                <AccordionItem
                  key={index}
                  value={`pricing-${index}`}
                  className="bg-gray-900/30 border border-gray-800 rounded-lg px-6 hover:border-violet-500/50 transition-colors !border-b-gray-800"
          ...
          <div className="space-y-6 mt-12">
            <h2 className="text-2xl font-bold text-white mb-4">Getting Started Questions</h2>
            <Accordion type="single" collapsible className="space-y-4">
              {faqs.slice(18).map((faq, index) => (
                <AccordionItem
                  key={index}
